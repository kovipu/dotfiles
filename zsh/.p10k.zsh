# Generated by Powerlevel10k configuration wizard on 2021-08-31 at 15:00 EEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 3380.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# round separators, round heads, round tails, 1 line, compact, few icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=10
